...
import { registerSchema, loginSchema, refreshSchema, forgotPasswordSchema, resetPasswordSchema, updateProfileSchema, } from '../schemas/auth.schema.js';
const auth = new Hono();
...
auth.post('/logout', authRateLimit, authMiddleware, async (c) => {

...
export async function listProjects(workspaceId, input) {
...
export async function getProjectBySlug(workspaceId, slug) {
...
export async function getProjectById(workspaceId, id) {
    const [project] = await db
        .select()
        .from(projects)
...
export async function updateProject(workspaceId, id, input) {
    const [project] = await db
        .update(projects)
        .set({
        ...input,
...
export async function getProjectActivity(workspaceId, projectId) {
    const [project] = await db
        .select()
        .from(projects)
        .where(and(eq(projects.workspaceId, workspaceId), eq(projects.id, projectId), isNull(projects.deletedAt)))

...
export async function updateSetting(workspaceId: string, key: string, value: any) {
...
export async function createApiKey(workspaceId: string, input: CreateApiKeyInput) {
...
export async function createWebhook(workspaceId: string, input: CreateWebhookInput) {
...
export async function updateWebhook(id: string, input: UpdateWebhookInput) {
  ...
  if (input.secret) updateData.secretHash = hashToken(input.secret)
